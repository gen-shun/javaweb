...
{
  "projectName" : "demo1",
  "repositoryPrefix" : "acrbs.azurecr.io/acrbs/acrbs"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->demo1]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->acrbs.azurecr.io/acr...(truncated)]
